...
The implementation keeps five agents in the internal operations team. An
external Customer Agent is documented as a later partner-facing extension and
is not part of that internal team boundary.
